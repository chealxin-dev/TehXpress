    ...
    <body>
        ...
        <div class="container">
            <div class="Details">
                ...
                <p class="MilkTeaName">Brown Sugar Boba Milk
</p>
                <p class="Description">A modern favorite, this drink features fresh milk swirled with thick, caramelized brown sugar syrup and served with chewy tapioca pearls. 
                                        The brown sugar adds a smoky, toasty sweetness, creating a rich, indulgent flavor with beautiful marbled layers.
                </p>
                <div class="Recipe">
                    <h3>🍮 Brown Sugar Boba Milk</h3>
                    <h4>Ingredient</h4>
                    <ul>
                        <li>🧋 100g tapioca pearls</li>
                        <li>🍮 3 tbsp brown sugar syrup</li>
                        <li>🥛 150ml fresh milk</li>
                    </ul>
                    <h4>Instructions:</h4>
                    <ul>
                        <li>1. Cook tapioca pearls until soft, then mix with brown sugar syrup.</li>
                        <li>2. Pour pearls into a glass and add fresh milk.</li>
                        <li>3. Serve with ice for a rich, creamy taste.</li>
                    </ul>
                </div>
            </div>
