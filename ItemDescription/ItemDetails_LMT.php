    ...
    <body>
        ...
        <div class="container">
            <div class="Details">
                ...
                <p class="Description">Elegant and refreshing, Lychee Milk Tea is infused with the sweet, 
                    floral essence of lychee fruit. Its light, delicate taste complements the creamy milk tea base, 
                    creating a fragrant, exotic beverage that is both smooth and uplifting. 
                    Perfect for those who enjoy floral-fruity notes.
                </p>
                ...
                <div class="Recipe">
                    ...
                    <h4>Instructions:</h4>
                    <ul>
                        <li>1. Brew black tea and cool it.</li>
                        <li>2. Stir in lychee syrup, milk, and tea.</li>
                        <li>3. Add ice and pearls if desired.</li>
                    </ul>
                </div>
