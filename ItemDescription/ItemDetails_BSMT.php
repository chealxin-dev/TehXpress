    ...
    <body>
        ...
        <div class="container">
            <div class="Details">
                ...
                <p class="Description">Unlike the pure milk version, Brown Sugar Milk Tea combines strong black tea with milk and sweet, 
                                    caramelized brown sugar syrup. The result is a deeper, richer flavor that is bold, creamy, and slightly 
                                    smoky.
                </p>
                ...
                <div class="Recipe">
                    ...
                    <ul>
                        ...
                        <li>🥛 150ml milk tea base</li>
                    </ul>
                    <h4>Instructions:</h4>
                    <ul>
                        <li>1. Brew milk tea base and let it cool.</li>
                        <li>2. Cook tapioca pearls and coat with brown sugar syrup.</li>
                        <li>3. Pour tea over pearls and serve chilled.</li>
                    </ul>
                </div>
            </div>
