    ...
    <body>
        ...
        <div class="container">
            <div class="Details">
                ...
                <p class="Description">A fun and fruity fusion, Grape Milk Tea delivers a burst of grape sweetness balanced by the creamy depth of milk tea. Its bold aroma and mellow finish make it a refreshing twist for fruit tea lovers looking for something playful yet satisfying.</p>

                <div class="Recipe">
                    <h3>🍇 Grape Milk Tea</h3>
                    <h4>Ingredient</h4>
                    <ul>
                        <li>🍇 3 tbsp grape syrup</li>
                        <li>🥛 150ml milk</li>
                    ...
                    <h4>Instructions:</h4>
                    <ul>
                        <li>1. Brew black tea and allow it to cool.</li>
                        <li>2. Mix grape syrup with milk and tea.</li>
                        <li>3. Serve with ice and pearls if desired.</li>
                    </ul>
                </div>
            </div>
