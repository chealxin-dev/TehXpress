    ...
    <body>
        ...
        <div class="container">
            <div class="Details">
                ...
                <p class="Description">A traditional Indian favorite, Masala Chai is a soul-warming drink made by simmering black tea with 
                    a mix of spices such as ginger, cardamom, cinnamon, cloves, and pepper. 
                    Blended with milk and sugar, it’s both invigorating and comforting, with a spicy aroma that awakens the 
                    senses and warms the spirit.
                </p>
                ...
                <div class="Recipe">
                    ...
                    <h4>Ingredient</h4>
                    <ul>
                        <li>🍵 2 tbsp black tea leaves</li>
                        <li>🥛 150ml milk</li>
                        <li>🍯 2 tbsp sugar</li>
                        <li>🌿 1 tsp chai spice mix (cinnamon, cardamom, cloves, ginger)</li>
                    </ul>
                    <h4>Instructions:</h4>
                    <ul>
                        <li>1. Boil tea leaves with spices in water.</li>
                        <li>2. Add milk and sugar, simmer for 3 mins.</li>
                        <li>3. Strain and serve hot.</li>
                    </ul>
                </div>
            </div>
