    ...
    <body>
        ...
        <div class="container">
            <div class="Details">
                ...
                <p class="MilkTeaName">Jasmine Milk Tea
</p>
                <p class="Description">Floral and aromatic, Jasmine Milk Tea infuses green tea with the delicate fragrance of jasmine blossoms.
                     Combined with smooth milk, it becomes a calming, lightly sweet drink with a natural floral finish, 
                     perfect for a refreshing and elegant experience.
                </p>
                <div class="Recipe">
                    <h3>🌸 Jasmine Milk Tea</h3>
                    <h4>Ingredient</h4>
                    <ul>
                        <li>🌸 2 tbsp jasmine tea leaves</li>
                        <li>🥛 150ml milk</li>
                        <li>🍯 2 tbsp sugar</li>
                        <li>🧊 Ice cubes</li>
                    </ul>
                    <h4>Instructions:</h4>
                    <ul>
                        <li>1. Brew jasmine tea and let it cool.</li>
                        <li>2. Mix tea with milk and sugar.</li>
