    ...
    <body>
        ...
        <div class="container">
            <div class="Details">
                ...
                <p class="Description">Sweet, fragrant peaches meet classic milk tea for a drink that is juicy, 
                    refreshing, and creamy at the same time. With a naturally fragrant aroma and a mellow finish, 
                    Peach Milk Tea is a soothing choice that pairs fruitiness with smoothness in perfect harmony.
                </p>
                <div class="Recipe">
                    <h3>🍑 Peach Milk Tea</h3>
                    <h4>Ingredient</h4>
                    <ul>
                        <li>🍑 3 tbsp peach syrup</li>
                        <li>🥛 150ml milk</li>
                    ...
                    <ul>
                        ...
                        <li>2. Mix peach syrup with milk and tea.</li>
                        <li>3. Serve chilled with ice and optional pearls.</li>
                    </ul>
                </div>
            </div>
