    ...
    <body>
        ...
        <div class="container">
            <div class="Details">
                ...
                <p class="Description">Made with semi-fermented oolong tea, this milk tea carries a complex flavor profile — 
                    somewhere between green and black tea. It has roasted, floral, and slightly sweet notes, which, 
                    when blended with creamy milk, create a smooth, aromatic beverage that is both unique and balanced.
                </p>
                ...
                <div class="Recipe">
                    ...
                    <h4>Ingredient</h4>
                    <ul>
                        <li>🌿 2 tbsp oolong tea leaves</li>
                        <li>🥛 150ml milk</li>
                        <li>🍯 2 tbsp sugar</li>
                        <li>🧊 Ice cubes</li>
                    </ul>
                    <h4>Instructions:</h4>
                    <ul>
                        <li>1. Brew oolong tea and cool it down.</li>
                        <li>2. Mix milk, sugar, and tea.</li>
