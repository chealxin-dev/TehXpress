    ...
    <body>
        ...
        <div class="container">
            <div class="Details">
                ...
                <p class="Description">Famous for its striking orange color and unique taste, Thai Milk Tea blends strong black tea with spices like star anise, tamarind, and cardamom. Sweetened with condensed milk and poured over ice, it delivers a creamy, fragrant, and refreshing tropical flavor that is both exotic and comforting.
                ...
                <div class="Recipe">
                    ...
                    <ul>
                        ...
                        <li>🥫 50ml evaporated milk</li>
                        <li>🧊 Ice cubes</li>
                    </ul>
                    <h4>Instructions:</h4>
                    <ul>
                        <li>1. Brew Thai tea mix and strain.</li>
                        <li>2. Stir in condensed milk and evaporated milk.</li>
                        <li>3. Serve over ice for a creamy finish.</li>
                    </ul>
                </div>
