    ...
    <body>
        ...
        <div class="container">
            <div class="Details">
                ...
                <p class="Description">A signature of Hong Kong’s bustling cha chaan teng cafés, this milk tea is made with a special mix of strong black teas, slow-brewed for depth. It is then combined with evaporated or condensed milk to produce a silky, velvety texture. The result is a powerful yet smooth drink that leaves a lingering, satisfying aftertaste.
                </p>
                ...
                <div class="Recipe">
                    ...
                    <h4>Ingredient</h4>
                    <ul>
                        <li>🍵 2 tbsp Ceylon black tea leaves</li>
                        <li>🥫 80ml evaporated milk</li>
                        <li>🍯 2 tbsp sugar</li>
                    </ul>
                    <h4>Instructions:</h4>
                    <ul>
                        <li>1. Brew strong black tea and strain.</li>
                        <li>2. Mix in evaporated milk and sugar.</li>
                        <li>3. Serve hot or iced.</li>
                    </ul>
                </div>
