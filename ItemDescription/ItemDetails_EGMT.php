    ...
    <body>
        ...
        <div class="container">
            <div class="Details">
                ...
                <p class="Description">Earl Grey Milk Tea blends bold black tea with the citrusy fragrance of bergamot. 
                    The addition of creamy milk mellows the strength of the tea while enhancing its floral-citrus notes, 
                    resulting in a refined drink that’s both sophisticated and comforting.
                </p>
                ...
                <div class="Recipe">
                    ...
                    <h4>Ingredient</h4>
                    <ul>
                        <li>🍂 2 tbsp Earl Grey tea leaves</li>
                        <li>🥛 150ml milk</li>
                        <li>🍯 2 tbsp sugar</li>
                        <li>🧊 Ice cubes</li>
                    </ul>
                    <h4>Instructions:</h4>
                    <ul>
                        <li>1. Brew Earl Grey tea and allow it to cool.</li>
                        <li>2. Combine milk, tea, and sugar, stirring well.</li>
                        <li>3. Serve hot or over ice.</li>
                    </ul>
                </div>
