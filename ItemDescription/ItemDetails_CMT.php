    ...
    <body>
        ...
        <div class="container">
            <div class="Details">
                ...
                <p class="Description">Chocolate Milk Tea combines rich cocoa with smooth brewed tea and creamy milk, 
                    creating a drink that is indulgent, velvety, and perfectly balanced. Its deep chocolate flavor pairs 
                    beautifully with the tea’s subtle notes, making it a comforting choice for sweet lovers.
                </p>
                ...
                <div class="Recipe">
                    ...
                    <h4>Instructions:</h4>
                    <ul>
                        <li>1. Brew black tea and let it cool slightly.</li>
                        <li>2. Mix cocoa powder with milk until smooth.</li>
                        <li>3. Stir in tea, sugar, and serve over ice.</li>
                    </ul>
                </div>
            </div>
