    ...
    <body>
        ...
        <div class="container">
            <div class="Details">
                ...
                <p class="Description">Coffee Milk Tea blends bold, aromatic coffee with silky milk tea for a drink that is smooth, 
                    creamy, and energizing. Perfect for coffee and tea lovers alike, it delivers a harmonious balance of 
                    roasted coffee richness and the mellow sweetness of milk tea.
                </p>
                ...
                <div class="Recipe">
                    ...
                    <h4>Instructions:</h4>
                    <ul>
                        <li>1. Brew coffee and black tea separately.</li>
                        <li>2. Combine coffee, tea, milk, and sugar.</li>
                        <li>3. Serve hot or iced for a bold, creamy drink.</li>
                    </ul>
                </div>
            </div>
