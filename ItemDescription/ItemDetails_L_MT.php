    ...
    <body>
        ...
        <div class="container">
            <div class="Details">
                ...
                <p class="Description">Lavender Milk Tea is calming and aromatic, made by blending lavender flowers with milk tea for 
                    a unique herbal-floral profile. Its gentle, soothing qualities make it a perfect drink to unwind with, 
                    offering a balance of creaminess and relaxation.
                </p>
                ...
                <div class="Recipe">
                    ...
                    <h4>Instructions:</h4>
                    <ul>
                        <li>1. Brew black tea with lavender, then strain.</li>
                        <li>2. Stir in milk and sugar.</li>
                        <li>3. Serve hot or cold.</li>
                    </ul>
                </div>
