    ...
    <body>
        ...
        <div class="container">
            <div class="Details">
                ...
                <p class="Description">Known for its vibrant purple hue, Taro Milk Tea is made with taro root, a starchy vegetable with naturally sweet, nutty, and vanilla-like notes. Combined with creamy milk tea, it has a smooth, velvety texture and a unique flavor that’s both earthy and indulgent. A colorful favorite for adventurous tea lovers.

                <div class="Recipe">
                    <h3>🍠 Taro Milk Tea</h3>
                    <h4>Ingredient</h4>
                    <ul>
                        <li>🍠 3 tbsp taro paste/powder</li>
                        <li>🥛 150ml milk</li>
                        <li>🍵 50ml black tea (optional)</li>
                        <li>🍯 2 tbsp sugar</li>
                    </ul>
                    <h4>Instructions:</h4>
                    <ul>

                        <li> 1.Mix taro paste with hot water until smooth.</li>
                        <li> 2.Stir in milk, sugar, and tea.</li>
                        <li> 3.Serve chilled with pearls if desired.</li>
                    </ul>
                </div>
