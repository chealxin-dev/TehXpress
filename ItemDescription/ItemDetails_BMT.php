    ...
    <body>
        ...
        <div class="container">
            <div class="Details">
                ...
                <p class="Description">Blending the tart sweetness of blueberries with rich milk tea, this drink is vibrant, refreshing, and smooth. 
                                        The slight tang of blueberries balances the creaminess, creating a harmonious taste that’s both refreshing \
                                        and indulgent.
                </p>

                <div class="Recipe">
                    <h3>🫐 Blueberry Milk Tea</h3>
                    <h4>Ingredient</h4>
                    <ul>
                        <li>🫐 3 tbsp blueberry syrup</li>
                        <li>🥛 150ml milk</li>
                    ...
                    <ul>
                        ...
                        <li>2. Stir blueberry syrup into milk and tea.</li>
